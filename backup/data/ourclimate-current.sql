...
INSERT INTO `accdec_questions` (`id`, `title`, `text`, `provided_answer`, `acceptID`, `declineID`, `type`, `threshold`, `location`) VALUES
...
(14, 'Subsidize purchases of electric cars ', 'Electric cars, when powered by nuclear energy, have much less emission rates than traditional cars. Subsidizing the use would enourage more adopters. ', NULL, 3, 1, 'accdec', NULL, NULL),
(15, 'Massive Flooding', 'The sea has gotten to a point where massive flooding can be seen, and people have begun moving inland. ', NULL, 1, 1, 'passiv', '{"sea", "100", "+"}', NULL),
...
(17, 'Widespread Droughts', 'Droughts are becoming a huge problem throughout the world due to the rising temperature.', NULL, 1, 1, 'passiv', '{"temperature", "65", "+"}', NULL),
(18, 'Nuisance Flooding', 'With the sea level at its current state, nuisance flooding will be a common occurrence. Flooding now occurs frequently only when confronted with high tide conditions.', NULL, 1, 1, 'passiv', '{"sea", "88", "+"}', NULL),
(19, 'Air Pollution', 'The rising temperatures have caused significant air pollution by increasing the ground level ozone. People could begin feeling the effects of this.', NULL, 1, 1, 'passiv', '{"temperature", "70", "+"}', NULL),
...
(21, 'Ozone Irreparable', 'Due to the extreme high rates of CO2 in the air, the ozone is now damaged to a irreparable state. Now it will never be back to how it was in the pre-industrial period. ', NULL, 1, 1, 'passiv', '{"co2", "1500", "+")', NULL);
