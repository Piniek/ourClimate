...
(2, 'Eliminate Subsidies for Fuel Use\r\n', 'Eliminating these subsidies could reduce energy use and decrease carbon emission levels. Cutting these subsidies will anger the oil companies, and it may be hard to pass legislation in the future. \r\n', NULL, 2, 1, 'accdec', NULL, NULL, 'The elimination of subsidies caused the oil prices to skyrocket. People around the world find public transportation more cost effective, leaving their cars at home. Those living in cities with no public transportation suffer from the increased gas prices. However as a result, CO2 emissions decrease. Additionally, the hike in gas prices increases demand for hybrid vehicles and companies start investing more in renewable energy.', 'The price of oil is at an all-time low, making gas extremely inexpensive. There is increased traffic on the roads, causing grid lock and many accidents. The increased demand for oil causes the level of CO2 emissions to rise more than before.'),
(3, 'Reduce Regulatory Barriers for New Nuclear Power Plants\r\n', 'Allowing more nuclear power plants to be made will cut back on other traditional energy sources which have high CO2 emission rates. This could upset some workers in the older coal power plants. \r\n', NULL, 2, 1, 'accdec', NULL, NULL, 'The number of nuclear power plants increased dramatically and the CO2 emissions decreased. While new nuclear plants offered jobs previously unavailable, there are increased job loss rates reported in traditional coal power plants. Additionally, many people are forced to relocate their houses to make room for the additional power plants, causing tension in many communities.', 'The level of CO2 emissions continues to rise, as more traditional coal power plants are built and maintained.'),
(4, 'Create Forest Management Institutions\r\n', 'Decreasing wildfires and having more regulated forest management could lead to a decrease in CO2 emissions.  Creating this institution is be a serious undertaking and will cost the government millions. \r\n', NULL, 5, 1, 'accdec', NULL, NULL, 'The creation of the institutions greatly reduced the number of wildfires and reduced the number of firefighters fighting them in the forests. This program cost millions of dollars to implement, which had to be cut from other government programs.', 'The government pumped the money into other programs. Wildfires continue to wipe out acres of forests, reducting the number of trees and their ability to produce Oxygen from CO2'),
